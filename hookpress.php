...
Plugin URI: http://kibopush.com/plugins/hookpress/
Description: HookPress turns all of your WordPress-internal hooks into webhooks. Possible uses include generating push notifications or using non-PHP web technology to extend WordPress.
Version: 2.0 (upgraded)
Author: Team Kibopush
Author URI: http://kibopush.com/
Donate link: http://kibopush.com/
*/
